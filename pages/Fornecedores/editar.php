        ...
        <form method="POST" action="<?php echo "{$url}!/{$link[1]}/{$link[2]}/{$id}" ?>" class="needs-validation" novalidate>
            <div class="row g-3">
                ...
                <div class="col-lg-4">
                    ...
                    <input type="text" class="form-control" name="whatsapp" value="<?= htmlspecialchars($fornecedor['whatsapp']) ?>">
                </div>
                <div class="col-lg-4">
                ...
                <div class="col-lg-4">
                    ...
                    <input type="text" class="form-control" id="bairro" name="bairro" value="<?= htmlspecialchars($fornecedor['bairro']) ?>">
                </div>
                <div class="col-lg-4">
                    <label for="" class="form-label">Estado</label>
                    <input type="text" class="form-control" id="estado" name="estado" value="<?= htmlspecialchars($fornecedor['estado']) ?>">
                </div>
                <div class="col-lg-4">
