          ...
          <div class="row g-3">
            ...
            <div class="col-lg-2">
              ...
              <select class="form-select" name="pedra" id="pedra">
                <option value="Nenhuma Pedra">Sem Pedra</option>
...
<script>
  ...
  function atualizarDescricaoEtiqueta() {
    ...
    descricaoEtiqueta.value = `${subgrupoText} - ${grupoText} - com ${pedravalor} - ${modeloText} - ${macica_ou_ocaText} - ${nat_ou_sintText} - ${unidadeText} - ${pesoValue}g - [ ${descricao_etiqueta_manualValue} ]`;
  }
