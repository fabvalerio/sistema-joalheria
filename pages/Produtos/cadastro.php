...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  if ($return) {
    // $return agora contém o ID do produto
    $produto_id = $return;
    $descricao = $dados['descricao_etiqueta'];
    ?>
<script>
// Mostrar notificação de sucesso e abrir modal
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.produtoEtiqueta = {
        id: <?php echo $produto_id; ?>,
...
<div class="card">
    ...
    <div class="card-body">
            ...
            <div class="row g-3">
                ...
                <div class="col-lg-4">
                    ...
                    <select class="form-select" name="fornecedor_id" id="fornecedor" required>
                        ...
                        <option value="<?= $fornecedor['id'] ?>"><?= htmlspecialchars($fornecedor['nome_fantasia']) ?>
                        </option>
                        <?php endforeach; ?>
                    </select>
                </div>
                ...
                <div id="campos-adicionais" style="display: none;">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-lg-12">
                            ...
                            <input type="text" class="form-control bg-secondary text-white" name="descricao_etiqueta"
                                id="descricao_etiqueta" readonly>
                        </div>
                        <!-- Descrição Adicional Etiqueta (Manual) -->
                        <div class="col-lg-12">
                            <label class="form-label">Descrição Adicional Etiqueta (opcional)</label>
                            <input type="text" class="form-control" name="descricao_etiqueta_manual"
            ...
            ?>
                        <div class="col-lg-2">
                            ...
                            <select class="form-select" name="material_id" id="material" required>
                                ...
                                <option value="<?= $material['id'] ?>"><?= htmlspecialchars($material['nome']) ?>
                                </option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                  ...
                  ?>
                                ...
                                <button type="button" class="btn bg-success text-white" data-bs-toggle="modal"
                                    data-bs-target="#modalNovoModelo">+</button>
                            </div>
                        </div>
                            ...
                            $.ajax({
                                ...
                                success: function(response) {
                                    if (response.success) {
                                        ...
                                        $("#modelo").append('<option value="' + novoModelo + '">' +
                                            novoModelo + '</option>');
                                        $("#modelo").val(novoModelo);
                                        atualizarDescricaoEtiqueta
                                    (); // Atualiza a etiqueta após fechar o modal
                                    } else {
                        ...
                        <div class="col-lg-2">
                            ...
                            <input type="number" class="form-control" name="cm" id="cm"
                                placeholder="Digite o valor em centímetros">
                        </div>
                  ...
                  ?>
                                ...
                                <button type="button" class="btn bg-success text-white" data-bs-toggle="modal"
                                    data-bs-target="#modalNovaPedra">+</button>
                            </div>
                        </div>
                            ...
                            $.ajax({
                                ...
                                success: function(response) {
                                    if (response.success) {
                                        ...
                                        $("#pedra").append('<option value="' + novaPedra + '">' +
                                            novaPedra + '</option>');
                                        $("#pedra").val(novaPedra);
                                        atualizarDescricaoEtiqueta
                                    (); // Atualiza a etiqueta após fechar o modal
                  ...
                  ?>
                                ...
                                <button type="button" class="btn bg-success text-white" data-bs-toggle="modal"
                                    data-bs-target="#modalNovaformato">+</button>
                            </div>
                        </div>
                            ...
                            $.ajax({
                                ...
                                success: function(response) {
                                    if (response.success) {
                                        ...
                                        $("#formato").append('<option value="' + novaformato + '">' +
                                            novaformato + '</option>');
                        ...
                        <div class="col-lg-2">
                            ...
                            <input type="number" class="form-control" name="mm" id="mm"
                                placeholder="Digite o valor em milímetros">
                        </div>
                        ...
                        <div class="col-lg-4">
                            ...
                            <select class="form-select" name="cotacao" id="cotacao" required>
                                ...
                                <option value="<?= $cotacao['id'] ?>" data-valor="<?= $cotacao['valor'] ?>">
                                    ...
                                    (<?= htmlspecialchars($cotacao['valor']) ?>)
                                </option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        ...
                        <div id="campos-cotacao" style="display: none;">
                            <div class="row g-3">
                                <div class="col-lg-2">
                                    ...
                                    <input type="number" step="0.01" class="form-control text-center" name="preco_ql"
                                        id="preco_ql">
                                </div>
                                <div class="col-lg-2">
                                    <label class="form-label">Peso Gr</label>
                                    <input type="number" step="0.001" class="form-control text-center" name="peso_gr"
                                        id="peso_gr">
                                </div>
                                <div class="col-lg-2">
                                    <label class="form-label">Margem (%)</label>
                                    <input type="number" step="0.01" class="form-control text-center" name="margem"
                                        id="margem">
                                </div>
                                <div class="col-lg-2">
                                    <label class="form-label">Custo</label>
                                    <input type="number" step="0.01"
                                        class="form-control bg-secondary text-white text-center" name="custo" id="custo"
                                        readonly>
                                </div>
                                <div class="col-lg-4">
                                    <label class="form-label">Em Reais</label>
                                    <input type="number" step="0.01"
                                        class="form-control bg-secondary text-white text-center" name="em_reais"
                                        id="em_reais" readonly>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="input-group">
                                <select class="form-select" name="insumos" id="insumos">
                                    ...
                                    <option value="<?= $insumo['id'] ?>"
                                        data-em-reais="<?= $insumo['em_reais'] ?? 0 ?>">
                                        <?= htmlspecialchars($insumo['descricao_etiqueta'] ?? '') ?>
                                    </option>
                                    <?php endforeach; ?>
                                </select>
                                <button type="button" class="btn btn-success" onclick="adicionarInsumo()">Adicionar
                                    Insumo</button>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" class="form-control" id="Res_Subtotal" placeholder="Subtotal"
                                            readonly>
                                    </div>
                                    <div class="col-lg-6">
                                        <label for="Res_Coeficente" class="form-label">Coeficiente Geral</label>
                                        <input type="text" class="form-control" id="Res_Coeficente"
                                            placeholder="Coeficiente Geral" readonly>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="modal fade" id="modalNovoModelo" tabindex="-1" aria-labelledby="modalNovoModeloLabel"
            aria-hidden="true">
        ...
        <div class="modal fade" id="modalNovaPedra" tabindex="-1" aria-labelledby="modalNovaPedraLabel"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <form id="formNovaPedra">
                            <div class="mb-3">
                                ...
                                <input type="hidden" class="form-control" id="tipoPedra" name="tipoPedra" value="pedra"
                                    required>
                            </div>
        ...
        <div class="modal fade" id="modalNovaformato" tabindex="-1" aria-labelledby="modalNovaformatoLabel"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <form id="formNovaformato">
                            <div class="mb-3">
                                ...
                                <input type="hidden" class="form-control" id="tipoformato" name="tipoformato"
                                    value="formato" required>
                            </div>
        ...
        <!-- Modal para adicionar etiquetas à fila de impressão -->
        <div class="modal fade" id="modalEtiquetas" tabindex="-1" aria-labelledby="modalEtiquetasLabel"
            aria-hidden="true" data-bs-backdrop="static">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header bg-primary text-white">
                        <h5 class="modal-title" id="modalEtiquetasLabel">Imprimir Etiquetas</h5>
                        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                            aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <p>Produto cadastrado com sucesso! Deseja adicionar etiquetas à fila de impressão?</p>
                        <div class="mb-3">
                            <label for="quantidadeEtiquetas" class="form-label">Quantidade de Etiquetas</label>
                            <input type="number" class="form-control" id="quantidadeEtiquetas"
                                name="quantidadeEtiquetas" min="1" max="999" value="1" required>
                            <small class="form-text text-muted">Digite um valor entre 1 e 999</small>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" onclick="pularEtiquetas()">Pular</button>
                        <button type="button" class="btn btn-primary" onclick="salvarEtiquetas()">Adicionar à
                            Fila</button>
                    </div>
                </div>
            </div>
...
[fornecedor, material, categoria, grupo, subgrupo, modelo, macica_ou_oca, nat_ou_sint, unidade, peso, pedra, numeros,
    aros, cm, mm, pontos, formato
].forEach(el => {
    const atualizar = () => {
...
function atualizarDescricaoEtiqueta() {
    ...
    const macica_ou_ocaText = macica_ou_oca.selectedIndex > 0 ? macica_ou_oca.options[macica_ou_oca.selectedIndex]
        ?.value : '';
...
function salvarEtiquetas() {
    ...
    // Validação
    if (!quantidade || quantidade < 1 || quantidade > 999) {
        alert('Por favor, informe uma quantidade válida entre 1 e 999.');
        return;
    }

    // Obter dados do produto
    const produto = window.produtoEtiqueta;
    ...
    // Obter seleções existentes do localStorage
    let etiquetas = {};
    try {
        const stored = localStorage.getItem(STORAGE_KEY);
        if (stored) {
            etiquetas = JSON.parse(stored);
        }
    } catch (e) {
    ...
    try {
        ...
        // Fechar modal
        const modalElement = document.getElementById('modalEtiquetas');
        ...
        const mensagem = quantidade === 1 ?
            '1 etiqueta adicionada à fila de impressão!' :
            `${quantidade} etiquetas adicionadas à fila de impressão!`;

        alert(mensagem);

        // Redirecionar após 500ms
        setTimeout(function() {
            window.location.href = '<?php echo $url; ?>!/<?php echo $link[1]; ?>/listar';
        }, 500);

    } catch (e) {
        console.error('Erro ao salvar no localStorage:', e);
        alert('Erro ao salvar etiquetas. Por favor, tente novamente.');
    }
}

function pularEtiquetas() {
...
// Validação em tempo real do input de quantidade
document.addEventListener('DOMContentLoaded', function() {
    const input = document.getElementById('quantidadeEtiquetas');
    if (input) {
        input.addEventListener('input', function() {
            let valor = parseInt(this.value);
            if (valor < 1) this.value = 1;
            if (valor > 999) this.value = 999;
        });
