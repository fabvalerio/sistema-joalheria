...
<div class="card">
    <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
        <h3 class="card-title">Materiais (Pagamento)</h3>
            ...
            <tbody>
                <?php foreach ($materiais as $mat): ?>
                    <tr>
                        ...
                        <td>R$ <?= number_format((float)($mat['valor_por_grama'] ?? 0), 2, ',', '.') ?></td>
                        <td>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="<?= "{$url}!/{$link[1]}/ver/{$mat['id']}" ?>" class="dropdown-item">Ver</a></li>
                                    <?php if (isset($podeManipular) && $podeManipular($link[1])): ?>
                                    <li><a href="<?= "{$url}!/{$link[1]}/editar/{$mat['id']}" ?>" class="dropdown-item">Editar</a></li>
                                    <li><a href="<?= "{$url}!/{$link[1]}/deletar/{$mat['id']}" ?>" class="dropdown-item text-danger">Excluir</a></li>
                                    <?php endif; ?>
                                </ul>
                            </div>
                        </td>
