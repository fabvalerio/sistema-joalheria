        ...
        <table id="example1" class="table table-striped">
            ...
            <tbody>
                <?php foreach ($cheques as $cheque): ?>
                    <tr>
                        <td><?= htmlspecialchars($cheque['nome_cheque']) ?></td>
                        <td><?= htmlspecialchars($cheque['max_parcelas']) ?>x</td>
                        <td>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="<?= "{$url}!/{$link[1]}/ver/{$cheque['id']}" ?>" class="dropdown-item">Ver</a></li>
                                    <?php if (isset($podeManipular) && $podeManipular($link[1])): ?>
                                    <li><a href="<?= "{$url}!/{$link[1]}/editar/{$cheque['id']}" ?>" class="dropdown-item">Editar</a></li>
                                    <!-- <li><a href="<?= "{$url}!/{$link[1]}/deletar/{$cheque['id']}" ?>" class="dropdown-item text-danger">Excluir</a></li> -->
                                    <?php endif; ?>
                                </ul>
                            </div>
                        </td>
