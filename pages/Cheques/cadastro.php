...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($return) {
        echo notify('success', "Cheque cadastrado com sucesso!");
        echo '<meta http-equiv="refresh" content="2; url=' . $url . '!/' . $link[1] . '/listar">';
    } else {
        echo notify('danger', "Erro ao cadastrar o cheque.");
    }
}
...
<div class="card">
  <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
    <h3 class="card-title">Cadastro de Cheque</h3>
    ...
    <form method="POST" action="<?php echo "{$url}!/{$link[1]}/{$link[2]}" ?>" class="needs-validation" novalidate>
      <div class="row g-3">
        <div class="col-lg-6">
          ...
          <input type="text" class="form-control" name="nome_cheque" required>
        </div>
        <div class="col-lg-6">
