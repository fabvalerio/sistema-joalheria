...
$is_admin = isset($_COOKIE['nivel_acesso']) && $_COOKIE['nivel_acesso'] === 'Administrador';
...
<!-- Linha de Alertas de Estoque Baixo -->
<?php //if (!empty($usuario_loja_id) || $is_admin): ?>
<div class="row mt-3">
  <?php //if (!empty($usuario_loja_id)): ?>
  <div class="col-xl-6 col-md-6 mb-4">
    <a href="<?= $url ?>!/Estoque/listar" class="text-decoration-none">
      <div class="card border-left-danger shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">
                Estoque da Loja — Alerta
              </div>
              <div class="h5 mb-0 font-weight-bold text-gray-800"><?= (int)$estoqueBaixoLoja ?> produto(s) com estoque baixo</div>
            </div>
            <div class="col-auto">
  ...
  <?php //if ($is_admin): ?>
  <div class="col-xl-6 col-md-6 mb-4">
    <a href="<?= $url ?>!/CD/estoque" class="text-decoration-none">
      <div class="card border-left-warning shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                Estoque do CD — Alerta
              </div>
              <div class="h5 mb-0 font-weight-bold text-gray-800"><?= (int)$estoqueBaixoCD ?> produto(s) com estoque baixo</div>
            </div>
            <div class="col-auto">
